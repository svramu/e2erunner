...
exports.getTitle = () => __awaiter(this, void 0, void 0, function* () {
    let title = yield protractor_1.browser.getTitle();
    return title;
});
exports.click = (l) => __awaiter(this, void 0, void 0, function* () {
    let elem = protractor_1.element(loc(l));
    yield elem.click();
});
//TBD: multi-select
exports.clickCtrl = (l) => __awaiter(this, void 0, void 0, function* () {
...
exports.pressEnter = (l) => __awaiter(this, void 0, void 0, function* () {
    let elem = protractor_1.element(loc(l));
    yield elem.sendKeys(protractor_1.protractor.Key.ENTER);
});
exports.dragAndDrop = (src, dst) => __awaiter(this, void 0, void 0, function* () {
...
exports.clickButtonByText = (partialText) => __awaiter(this, void 0, void 0, function* () {
    let elem = protractor_1.element(protractor_1.by.partialButtonText(partialText));
    yield elem.click();
});
exports.clickLink = (partialText) => __awaiter(this, void 0, void 0, function* () {
...
exports.clickLinks = (partialTexts) => __awaiter(this, void 0, void 0, function* () {
...
exports.getText = (l) => __awaiter(this, void 0, void 0, function* () {
    let txt = yield protractor_1.element(loc(l)).getText();
    return txt;
});
exports.inputText = (l, text) => __awaiter(this, void 0, void 0, function* () {
    let elem = protractor_1.element(loc(l));
